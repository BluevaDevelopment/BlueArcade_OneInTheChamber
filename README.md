...
- `/baa game [arena_id] one_in_the_chamber setmode <last_standing|most_kills>` — Choose the win condition.
- `/baa game [arena_id] one_in_the_chamber setregion set` — Select and save the play region.
